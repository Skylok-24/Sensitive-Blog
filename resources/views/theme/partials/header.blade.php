@php
    ...
    $headerCategories = Category::take(3)->get();
                    ...
                    <ul class="nav navbar-nav navbar-right navbar-social">
                        ...
                        @else
                            <li class="nav-item submenu dropdown">
                                <a href="#" class="nav-link dropdown-toggle mx-3" data-toggle="dropdown"
                                    role="button" aria-haspopup="true" aria-expanded="false">Welcome
                                    {{ Auth::user()->name }}</a>
                                <ul class="dropdown-menu">
                                    <li class="nav-item"><a class="nav-link" href="{{ route('theme.singleBlog') }}">My
                                            Blogs</a></li>
                                    <li class="nav-item">
